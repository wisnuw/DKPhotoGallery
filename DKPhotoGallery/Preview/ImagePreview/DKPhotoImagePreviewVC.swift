...
class DKPhotoImagePreviewVC: DKPhotoBaseImagePreviewVC {
    ...
    private func downloadImage(with identifier: Any,
        ...
        SDImageCache.shared.queryCacheOperation(forKey: key, options: SDImageCacheOptions(rawValue: 1 << 2).union(SDImageCacheOptions.queryMemoryDataSync)) { (image, data, cacheType) in
